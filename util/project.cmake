...
macro(project name)
    ...
    if(${COMPILE_UNIT_TEST} STREQUAL "UNIT_TEST")
        ...
        message("DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR} DESTINATION ${SDK_PATH}/public/include/")
        message("CMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}")
        install(DIRECTORY code/inc_pub DESTINATION include)
        message("aaaaaaaaaaaaa FILES ${CMAKE_BINARY_DIR}/${name_output}    DESTINATION ${SDK_PATH}/public/output/bin/ut/${platform}/${CMAKE_COMPILE_TYPE}")
        install(FILES ${CMAKE_BINARY_DIR}/${name_output}    DESTINATION ${SDK_PATH}/public/output/bin/ut/) #${platform}/${CMAKE_COMPILE_TYPE})
    else()
        set(name_output ${name})
        #add_library(${name_output} "${exe_src}")
        message("aaaaaaaaaaaaa ${SDK_PATH}/public/output/bin/lib/")
        message("FILES ${CMAKE_BINARY_DIR}/code/${name_output}    DESTINATION ${SDK_PATH}/public/output/bin/lib/${platform}/${CMAKE_COMPILE_TYPE}")
        install(DIRECTORY DESTINATION ${SDK_PATH}/public/output/bin/lib/)
        install(FILES ${CMAKE_BINARY_DIR}/code/${name_output}    DESTINATION ${SDK_PATH}/public/output/bin/lib/${platform}/${CMAKE_COMPILE_TYPE})
        message("4444444444 ${SDK_PATH}/public/include/${name_output}")
        message("FILES ${PROJECT_SOURCE_DIR}/code/inc_pub         DESTINATION ${SDK_PATH}/public/include/${name_output}")
        install(DIRECTORY DESTINATION ${SDK_PATH}/public/include/${name_output})
        install(FILES ${PROJECT_SOURCE_DIR}/code/inc_pub         DESTINATION ${SDK_PATH}/public/include/${name_output})
    endif()
